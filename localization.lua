...
Results will print here when done.]],
  ...
  ["PHYS DPS"] = true,
  -- shootyepgp
  ["{BoW-EPGP}Type \"+\" if on main, or \"+<YourMainName>\" (without quotes) if on alt within %dsec."] = true,
  ...
  ["Restart"] = true,  
  ["Restart BoW-EPGP if having startup problems."] = true,
  ["Standings"] = true,  
  ["Show Standings Table."] = true,
  ["v%s Loaded."] = true,  
  ...
  ["Loot info can be cleared at any time from the Tablet context menu or '/bowepgp clearloot' command"] = true,
...
L:RegisterTranslations("zhCN", function() return {
  ...
  -- reserves
  ["BoW-EPGP reserves"] = "BoW-EPGP 替补成员",
  ["Countdown"] = "倒计时",
  ["Rank"] = "Rank",
  ["OnAlt"] = "OnAlt",
     -- standings
  ...
  ["Imported %d members.\n"] = "导入 %d 成员.\n",  
  ["%s\nFailed to import:"] = "%s\n未能导入:",
  ["BoW-EPGP Standings"] = "BoW-EPGP 名单列表",
  ["Group by class"] = "职业分组",
...
完成后打印结果.]],
  ...
  ["PHYS DPS"] = "PHYS DPS",
  -- shootyepgp
  ["{BoW-EPGP}Type \"+\" if on main, or \"+<YourMainName>\" (without quotes) if on alt within %dsec."] = "{BoW-EPGP}使用 \"+\" 如果你在大号上, 或者 \"+<YourMainName>\" (没有引号) 如果在小号 %d秒.",
  ...
  ["Restart"] = "重新开始",  
  ["Restart BoW-EPGP if having startup problems."] = "重新开始 BoW-EPGP，如果有启动问题.",
  ["Standings"] = "排名",  
  ["Show Standings Table."] = "显示排名表.",
  ["v%s Loaded."] = "v%s 加载.",  
  ...
  ["Loot info can be cleared at any time from the Tablet context menu or '/bowepgp clearloot' command"] = "拾取信息可以随时从小地图上下文菜单中清除，或者用 '/bowepgp clearloot' 命令",
